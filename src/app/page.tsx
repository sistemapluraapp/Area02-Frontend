      ...
      <main style={{ maxWidth: '1040px', margin: '0 auto', padding: '2rem 1.25rem 3rem', position: 'relative', zIndex: 1 }}>
        ...
        {carregando ? (
          ...
          <div style={{ textAlign: 'center', padding: '3rem 1.5rem', borderRadius: '1.25rem', border: 'var(--c-border)', background: 'var(--c-glass-bg)' }}>
            ...
            <p style={{ fontSize: '1.0625rem', fontWeight: 600, marginBottom: '0.25rem' }}>Você ainda não tem nenhuma página</p>
            <p style={{ fontSize: '0.9rem', color: 'var(--c-text-2)', marginBottom: '1.25rem' }}>Crie a página do seu empreendimento para começar.</p>
            {botaoNova}
          </div>
        ) : (
