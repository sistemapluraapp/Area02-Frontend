    ...
    <>
      ...
      <main id="conteudo" tabIndex={-1} style={{ maxWidth: '720px', margin: '0 auto', padding: '1.75rem 1.25rem 3rem', position: 'relative', zIndex: 1 }}>
        ...
        <form onSubmit={criar} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <Secao titulo="Nova página do empreendimento" descricao="Comece pelo essencial. Depois você completa acessibilidade, fotos, horários e experiências no editor.">
            <Campo rotulo="Nome do empreendimento *">
              <Texto valor={nome} onChange={setNome} max={120} placeholder="Sinais do Mar" />
            </Campo>
